...
- [x] Create `devtools/common/debate-machine/src/machine.ts` — xstate machine (see Spec section 1)
  ...
  - **Outcome**: Declarative state machine matching current transition table from `devdocs/misc/devtools/debate.md` section 2.1.2
...
- [x] Update `devdocs/misc/devtools/debate.md` — updated data flow and components sections
